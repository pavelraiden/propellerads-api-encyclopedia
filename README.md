...
Для получения подробных инструкций по установке для Windows, macOS и Linux, пожалуйста, обратитесь к нашему [Подробному Руководству по Установке](INSTALL_GUIDE.md).
