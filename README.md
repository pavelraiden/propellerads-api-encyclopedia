...
Для более удобного управления, в проект включен современный веб-интерфейс. 

**Возможности:**
- **Дашборд в реальном времени**: отслеживайте баланс, кампании и ключевые метрики.
- **Интерактивный чат с Claude AI**: получайте советы и управляйте кампаниями на естественном языке.
- **Управление кампаниями**: просматривайте и редактируйте кампании прямо в браузере.
